...
go build -ldflags '-w -s' -o hacash_node_2020_10_17_02 miner/run/main/main.go
go build -ldflags '-w -s' -o  poolworker_2020_10_17_02 miner/run/minerworker/main.go
go build -ldflags '-w -s' -o   cmdwallet_2020_10_17_02 cmdwallet/run/main/main.go
