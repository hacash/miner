...
go build -ldflags '-w -s' -o hacash_node_2020_10_13_01 miner/run/main/main.go
go build -ldflags '-w -s' -o  poolworker_2020_10_13_01 miner/run/minerworker/main.go
go build -ldflags '-w -s' -o   cmdwallet_2020_10_13_01 cmdwallet/run/main/main.go
